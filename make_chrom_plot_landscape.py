...
def main():
    ...
    with open("chrom_plot_ls.svg", "wt") as svg_out:
        ...
        body += write_text(x=50 + (scale_x_length)/2, y=65, text="1 Mbp")
        ...
        for i, (region_id, region) in enumerate(regions.items()):
            ...
            body += write_text(x=x + 5, y=y_start + 15, text="Chr{chrom}".format(**region))
